...
// Lab2_server.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLab2S, CWinApp)
...
// Единственный объект CLab2S

CLab2S theApp;


// инициализация CLab2S

BOOL CLab2S::InitInstance()
{
